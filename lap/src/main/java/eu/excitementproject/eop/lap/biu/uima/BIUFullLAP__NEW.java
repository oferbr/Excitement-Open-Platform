 ...
 * @since May 2013
 */
public class BIUFullLAP__NEW extends LAP_ImplBaseAE implements LAPAccess {

	protected BIUFullLAP__NEW() throws LAPException {
		super();
	}

	public void init(String taggerModelFile, String nerModelFile,
	...
	public void init(NameValueTable section) throws LAPException, ConfigurationException {
		init(
	...
	public void init(CommonConfig config) throws LAPException, ConfigurationException {
		init(config.getSection(DEFAULT_SECTION_NAME));
	}
